...
export async function checkUserRoles(accessToken) {
  ...
  try {
    ...
    // 🐛 DEBUG TEMPORAL: borrar esta línea después de confirmar que funciona.
    console.log('DEBUG guilds del usuario:', guilds.map(g => ({ id: g.id, name: g.name })));
    ...
    for (const guild of guilds) {
      try {
        ...
        // 🐛 DEBUG TEMPORAL: borrar este console.log después de confirmar.
        console.log(`DEBUG roles en guild ${guild.id} (${guild.name}):`, roles);
